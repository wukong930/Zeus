    ...
    async def evaluate(self, context: TriggerContext) -> TriggerResult | None:
        ...
        trigger_chain = [
            ...
            build_trigger_step(
                3,
                "event_likelihood",
                "Gap and volume both triggered." if combined else "Single event proxy triggered.",
        ...
        return TriggerResult(
            ...
            risk_items=[
                ...
                "External event may be driving the move.",
            ],
            manual_check_items=[
                "Check news, policy announcements, and exchange notices.",
                "Confirm liquidity around the move.",
                "Assess whether the event has durable fundamental impact.",
            ],
            title=f"{context.symbol1} event-driven signal",
            summary=(
